...
// Returns a *NotSingularError when exactly one Index entity is not found.
...
// Returns a *NotSingularError when exactly one Index ID is not found.
...
func (iq *IndexQuery) GroupBy(field string, fields ...string) *IndexGroupBy {
	group := &IndexGroupBy{config: iq.config}
...
func (iq *IndexQuery) Select(fields ...string) *IndexSelect {
	...
	return &IndexSelect{IndexQuery: iq}
}
...
func (iq *IndexQuery) sqlAll(ctx context.Context) ([]*Index, error) {
	var (
		nodes = []*Index{}
		_spec = iq.querySpec()
	)
...
func (iq *IndexQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (igb *IndexGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(igb.fields) > 1 {
		return nil, errors.New("ent: IndexGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := igb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (igb *IndexGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{index.Label}
	default:
		err = fmt.Errorf("ent: IndexGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (igb *IndexGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(igb.fields) > 1 {
		return nil, errors.New("ent: IndexGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := igb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (igb *IndexGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{index.Label}
	default:
		err = fmt.Errorf("ent: IndexGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (igb *IndexGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(igb.fields) > 1 {
		return nil, errors.New("ent: IndexGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := igb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (igb *IndexGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{index.Label}
	default:
		err = fmt.Errorf("ent: IndexGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (igb *IndexGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(igb.fields) > 1 {
		return nil, errors.New("ent: IndexGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := igb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (igb *IndexGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{index.Label}
	default:
		err = fmt.Errorf("ent: IndexGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (igb *IndexGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (igb *IndexGroupBy) sqlQuery() *sql.Selector {
...
func (is *IndexSelect) Scan(ctx context.Context, v interface{}) error {
	...
	is.sql = is.IndexQuery.sqlQuery(ctx)
...
func (is *IndexSelect) Strings(ctx context.Context) ([]string, error) {
	if len(is.fields) > 1 {
		return nil, errors.New("ent: IndexSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := is.Scan(ctx, &v); err != nil {
		return nil, err
...
func (is *IndexSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{index.Label}
	default:
		err = fmt.Errorf("ent: IndexSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (is *IndexSelect) Ints(ctx context.Context) ([]int, error) {
	if len(is.fields) > 1 {
		return nil, errors.New("ent: IndexSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := is.Scan(ctx, &v); err != nil {
		return nil, err
...
func (is *IndexSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{index.Label}
	default:
		err = fmt.Errorf("ent: IndexSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (is *IndexSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(is.fields) > 1 {
		return nil, errors.New("ent: IndexSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := is.Scan(ctx, &v); err != nil {
		return nil, err
...
func (is *IndexSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{index.Label}
	default:
		err = fmt.Errorf("ent: IndexSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (is *IndexSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(is.fields) > 1 {
		return nil, errors.New("ent: IndexSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := is.Scan(ctx, &v); err != nil {
		return nil, err
...
func (is *IndexSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{index.Label}
	default:
		err = fmt.Errorf("ent: IndexSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (is *IndexSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
